...
CREATE TABLE IF NOT EXISTS `mydb`.`blocks` (
  ...
  `blocked_id` INT NULL,
  `users_user_id` INT NOT NULL,
  PRIMARY KEY (`blocked_id`, `users_user_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`pictures` (
  ...
  `tweets_tweet_id` INT NOT NULL,
  `tweets_users_user_id` INT NOT NULL,
  PRIMARY KEY (`pic_id`, `tweets_tweet_id`, `tweets_users_user_id`),
  INDEX `fk_pictures_tweets1_idx` (`tweets_tweet_id` ASC, `tweets_users_user_id` ASC) VISIBLE,
